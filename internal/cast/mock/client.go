...
// Source: castai-agent/internal/cast (interfaces: Client)
...
func (m *MockClient) RegisterCluster(arg0 context.Context, arg1 *cast.RegisterClusterRequest) (*cast.RegisterClusterResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RegisterCluster", arg0, arg1)
	ret0, _ := ret[0].(*cast.RegisterClusterResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) SendClusterSnapshot(arg0 context.Context, arg1 *cast.Snapshot) error {
	m.ctrl.T.Helper()
